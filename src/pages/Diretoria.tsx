          ...
          <tbody className="divide-y divide-slate-200 bg-white">
            {currentItems.map((membro) => (
              <tr key={membro.id}>
                <td className="whitespace-nowrap py-4 pl-4 pr-3 sm:pl-6">
                  <div className="flex items-center">
                    <div className="h-10 w-10 flex-shrink-0">
                      <img className="h-10 w-10 rounded-full bg-slate-100" src={`https://picsum.photos/seed/diretor${membro.id}/100/100`} alt="" referrerPolicy="no-referrer" />
                    </div>
                    <div className="ml-4">
                ...
                <td className="whitespace-nowrap px-3 py-4 text-sm text-slate-500">{membro.cargo}</td>
