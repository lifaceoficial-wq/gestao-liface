                ...
                <tr key={atleta.id} className="hover:bg-slate-50">
                  ...
                  <td className="whitespace-nowrap py-4 pr-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      {atleta.telefone && (
                        <a href={`https://wa.me/55${atleta.telefone.replace(/\D/g, '')}`} target="_blank" rel="noreferrer" className="text-emerald-600 hover:text-emerald-700 p-1.5 rounded-md hover:bg-emerald-50" title="WhatsApp">
